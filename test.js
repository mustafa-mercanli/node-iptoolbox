...
(async () => {
    ...
    console.log(await ip.ping()); // Returns String. Gives ping result of the ip.
    console.log(await ip.pingable()); // Returns Boolean. Gives ip is pingable.
    console.log(await ip.portOpen(80)) // Returns Boolean. Gives port is reachable on this ip.
})();
